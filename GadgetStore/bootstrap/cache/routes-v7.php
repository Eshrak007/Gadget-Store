...
app('router')->setCompiledRoutes(
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::Hm0PTCE7xYTNDw3P',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::SDXiX4O0X8ThucAh',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::fZ7MBNYoCG5XcReJ',
          ),
          1 => NULL,
          2 => 
          array (
    ...
    2 => 
    array (
      0 => '{^(?|/productdetails/([^/]++)(*:31)|/dashboard/product/(?|edit/([^/]++)(*:73)|update/([^/]++)(*:95)|delete/([^/]++)(*:117))|/cart/remove/([^/]++)(*:147)|/reset\\-password/([^/]++)(*:180)|/verify\\-email/([^/]++)/([^/]++)(*:220))/?$}sDu',
    ),
    3 => 
    array (
      31 => 
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\Frontend\\FrontendController@singleProduct',
        'controller' => 'App\\Http\\Controllers\\Frontend\\FrontendController@singleProduct',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'controller' => 'App\\Http\\Controllers\\Backend\\ProductController@add',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\CartController@cartinfo',
        'controller' => 'App\\Http\\Controllers\\CartController@cartinfo',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
